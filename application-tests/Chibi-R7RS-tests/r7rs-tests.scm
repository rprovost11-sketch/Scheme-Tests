...
(import (scheme base) (scheme char) (scheme lazy)
        ...
        (scheme r5rs)
        (srfi 64)  ; local partial harness in ./srfi/64.sld (was: (chibi test))
        )
...
;; (These were commented out in chibi's original because chibi rejects them,
;; but R7RS 7.1.1 defines <complex R> for every radix; pyscheme/cppscheme2
;; parse them, matching Chez.)
